...
public class GeovelocityFunctionsServiceComponent {
    ...
    protected void activate(ComponentContext ctxt) {
        ...
        org.wso2.carbon.identity.conditional.auth.functions.geovelocity.CheckBrowserFunction checkBrowswerImpl = new org.wso2.carbon.identity.conditional.auth.functions.geovelocity.CheckBrowserFunctionImpl();
        jsFunctionRegistry.register(JsFunctionRegistry.Subsystem.SEQUENCE_HANDLER, "checkBrowser", checkBrowswerImpl);
        org.wso2.carbon.identity.conditional.auth.functions.geovelocity.CheckOSFunction checkOsImpl = new org.wso2.carbon.identity.conditional.auth.functions.geovelocity.CheckOSFunctionImpl();
        jsFunctionRegistry.register(JsFunctionRegistry.Subsystem.SEQUENCE_HANDLER, "checkOS", checkOsImpl);
    ...
    protected void deactivate(ComponentContext ctxt) {
        ...
        if (jsFunctionRegistry != null) {
            ...
            jsFunctionRegistry.deRegister(JsFunctionRegistry.Subsystem.SEQUENCE_HANDLER, "checkBrowser");
            jsFunctionRegistry.deRegister(JsFunctionRegistry.Subsystem.SEQUENCE_HANDLER, "checkOS");
